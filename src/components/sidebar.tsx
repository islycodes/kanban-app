      ...
      <div className="min-w-[300px] flex select-none">
        <div className="w-full flex flex-col justify-between bg-[#1D1E20] p-6 border-[#000000] border-r-[1px] ">
          <div>
            ...
            <div className="mt-10">
              <div onClick={() => navigate("/inicio")} className="flex ml-2 cursor-pointer flex-row justify-between items-center">
              ...
              <div onClick={() => navigate("/quadro")} className="flex mt-4 ml-2 cursor-pointer flex-row justify-between items-center">
                <div className="flex flex-row">
              ...
              <div onClick={notAdded} className="flex mt-4 ml-2 cursor-pointer flex-row justify-between items-center">
                <div className="flex flex-row">
              ...
              <div onClick={() => navigate("/relatorios")} className="flex mt-4 ml-2 cursor-pointer flex-row justify-between items-center">
                <div className="flex flex-row">
            ...
            <div className="mt-10 ml-3">
              ...
              {open && (
                <>
                  <div onClick={() => navigate("/importar")} className="flex mt-4 cursor-pointer flex-row justify-between items-center">
                    <div className="flex flex-row">
                      <ImportIcon width={24} height={24} />
                      <p className="ml-4 text-[#A9A9A9] font-medium">Importar</p>
                    </div>
                    {generateMarker("/importar")}
                  </div>
                  <div onClick={() => navigate("/exportar")} className="flex mt-4 cursor-pointer flex-row justify-between items-center">
                    <div className="flex flex-row">
                      <ExportIcon width={24} height={24} />
                      <p className="ml-4 text-[#A9A9A9] font-medium">Exportar</p>
                    </div>
          ...
          <div className="flex flex-col ml-3 pb-6">
            <div className="border-t-[1px] border-[#3F3F3F] w-full">
              <div onClick={() => navigate("/sobre")} className="flex mt-4 cursor-pointer flex-row justify-between items-center">
                <div className="flex flex-row">
              ...
              <div onClick={() => notAdded()} className="flex mt-4 cursor-pointer flex-row justify-between items-center">
                <div className="flex flex-row">
